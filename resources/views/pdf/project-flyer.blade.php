...
<head>
    ...
    */
    ...
    $instagramSvg = 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0AB600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
        <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
        <line x1="17.5" x2="17.51" y1="6.5" y2="6.5" />
    </svg>');
    $webSvg = 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0AB600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="12" r="10" />
        <line x1="2" x2="22" y1="12" y2="12" />
        <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
    </svg>');
    $youtubeSvg = 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0AB600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // Logo STAS RG diambil langsung dari asset statis, bukan lagi
    // dari data yang dikirim controller — supaya selalu memakai
    // logo resmi public/assets/img/stas.png dan tidak bergantung
    // pada apakah controller sudah mengirim $images['stas_logo'].
    $stasLogoPath = public_path('assets/img/stas.png');
    $stasLogoB64 = file_exists($stasLogoPath)
    ? 'data:image/png;base64,' . base64_encode(file_get_contents($stasLogoPath))
    : ($images['stas_logo'] ?? null);
    ...
    */
    ...
    <style>
        ...
        @endif @if($fontItalicB64) @font-face {
            font-family: 'Poppins';
            font-style: italic;
            font-weight: 400;
        ...
        @endif @if($fontSemiBoldB64) @font-face {
            font-family: 'Poppins';
            font-style: normal;
            font-weight: 600;
        ...
        @endif @if($fontBoldB64) @font-face {
            font-family: 'Poppins';
            font-style: normal;
            font-weight: 700;
        ...
        @endif @if($fontExtraBoldB64) @font-face {
            font-family: 'Poppins';
            font-style: normal;
            font-weight: 800;
        ...
        * {
        ...
        /* Area konten diberi ruang khusus agar tidak pernah bertabrakan
           dengan footer yang diposisikan tetap di dasar halaman. */
        .content-area {
            padding-bottom: 31mm;
        }
        ...
        /* Wordmark "STAS RG" — dibuat langsung dari teks + ikon SVG,
           bukan bergantung pada gambar dari server, supaya logo
           selalu tampil lengkap (teks + ikon) dan tidak pernah
           hilang tulisannya seperti sebelumnya. */
        .stasrg-logo {
    ...
    <div class="page">
        <div class="content-area">
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td class="logos-cell" style="width: 70%;">
                        ...
                        @else
                        {{-- Fallback: logo asli tidak ditemukan di server,
                         tampilkan wordmark "STAS RG" dari teks + ikon
                         supaya logo tetap tampil lengkap, bukan kosong
                         atau cuma ikon tanpa tulisan. --}}
                        <span class="stasrg-logo">
                            <span class="stasrg-logo-cell stasrg-logo-text">STAS R</span>
                            <span class="stasrg-logo-cell"><img src="{{ $stasIconSvg }}" class="stasrg-logo-icon" alt="G"></span>
                        </span>
                        @endif
                    </td>
                </tr>
            ...
            <div class="badge-container">
                <div class="partner-badge"><span class="partner-badge-text">{{ $project->subtitle }}</span></div>
            </div>
            @endif
                    ...
                    <td class="footer-right">
                        <div class="qr-wrapper">
                            ...
                            <div class="qr-box">
                                ...
                                @else
                                <div class="qr-image" style="line-height: 58px; text-align: center; font-size: 7pt; color: #9ca3af;">[QR]</div>
                                @endif
                            </div>
                        </div>
                    </td>
