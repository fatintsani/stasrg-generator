...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; overflow-wrap: break-word; word-break: break-word; }
        ...
        .stasrg-logo-icon { width: 22px; height: 22px; display: block; }
        ...
        /* SECTIONS */
        .sections-container { margin-bottom: 0; }
        .section-item { margin-bottom: 5px; }
        .section-table { width: 100%; border-collapse: collapse; }
        .section-table td { vertical-align: top; }

        .icon-cell { width: 34px; padding-top: 1px; }
        .icon-img { width: 25px !important; height: 25px !important; }

        .content-cell { padding-left: 5px; }
        .section-title {
            font-family: 'Poppins', sans-serif;
            font-size: 10.5pt;
            font-weight: 800;
        ...
        .section-text ul, .description ul { list-style-type: disc; margin-left: 14px; margin-top: 2px; margin-bottom: 1px; }
        ...
        .problem-solution-box div + div { margin-top: 2px; }
        ...
        .social-icon-cell { padding-right: 4px; padding-top: 2px; }
        .social-text-cell {
            font-family: 'Poppins', sans-serif;
            font-size: 8pt;
            color: #1f2937;
        ...
        .social-icon-img { width: 13px; height: 13px; display: block; }
