        ...
        setMessages([
            {
                id: 'welcome-reset',
                role: 'assistant',
                content: `Percakapan telah direset. Halo **${user.name || 'Administrator'}**, NARA siap membantu Anda kembali menganalisis sistem STASIKATOR. Silakan ajukan pertanyaan atau instruksi Anda.`,
                timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
            }
        ]);
    ...
    return (
        <AdminLayout title="NARA AI Assistant">
            ...
            <div className="space-y-5">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-white dark:bg-[#121824] border border-zinc-200/80 dark:border-zinc-800 shadow-xs">
                    <div className="flex items-center gap-3.5">
                        <div className="relative w-12 h-12 rounded-2xl overflow-hidden border-2 border-[#0AB600]/40 bg-zinc-100 dark:bg-zinc-800 shrink-0">
                            <img
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5 flex items-center gap-2">
                                <span>Akses Penuh Basis Data STASIKATOR CoE STAS-RG</span>
                                <span>•</span>
                                <span className="font-mono text-[#0AB600] font-semibold">
                                    {aiConfig.provider === 'gemini' ? 'Google Gemini AI' : 'OpenAI'} ({aiConfig.model})
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-auto flex-wrap">
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all cursor-pointer ${
                                isAutoVoice
                                    ...
                                    : 'bg-zinc-100 dark:bg-zinc-800/80 text-zinc-500 dark:text-zinc-400 border-zinc-200/60 dark:border-zinc-700/60 hover:text-slate-900 dark:hover:text-white'
                            }`}
                        >
                            {isAutoVoice ? (
                                <>
                                    <Volume2 className="w-3.5 h-3.5 text-[#0AB600] animate-pulse" />
                                    <span className="hidden sm:inline">Suara Otomatis: On</span>
                                </>
                            ) : (
                                <>
                                    <VolumeX className="w-3.5 h-3.5" />
                                    <span className="hidden sm:inline">Suara Otomatis: Off</span>
                                </>
                            )}
                        </button>

                        {/* Language Selector */}
                        <div className="inline-flex p-1 rounded-xl bg-zinc-100 dark:bg-zinc-800/80 border border-zinc-200/60 dark:border-zinc-700/60 text-xs font-semibold">
                            <button
                                type="button"
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-red-50 dark:hover:bg-red-950/30 text-xs font-semibold text-zinc-600 dark:text-zinc-300 hover:text-red-600 dark:hover:text-red-400 border border-zinc-200 dark:border-zinc-700 transition-colors cursor-pointer"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
                    ...
                    <div className="lg:col-span-8 flex flex-col h-[700px] rounded-2xl bg-white dark:bg-[#121824] border border-zinc-200/80 dark:border-zinc-800 shadow-xs overflow-hidden">
                        ...
                        <div className="p-3 sm:p-4 border-t border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-[#121824]">
                            <div className="relative flex items-end gap-2 p-2 rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 focus-within:border-[#0AB600] focus-within:ring-2 focus-within:ring-[#0AB600]/20 transition-all">
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-xl text-zinc-500 hover:text-[#0AB600] hover:bg-zinc-200/70 dark:hover:bg-zinc-800 transition-colors shrink-0 cursor-pointer"
                                >
                                ...
                                <button
                                    ...
                                    className={`p-2 rounded-xl transition-all shrink-0 cursor-pointer ${
                                        isListening
                                            ...
                                            : 'text-zinc-500 hover:text-[#0AB600] hover:bg-zinc-200/70 dark:hover:bg-zinc-800'
                                    }`}
                                >
                                    {isListening ? (
                                ...
                                <textarea
                                    ...
                                    className="flex-1 bg-transparent border-0 resize-none py-1.5 px-1 text-xs sm:text-sm text-slate-900 dark:text-zinc-100 placeholder:text-zinc-400 focus:ring-0 focus:outline-none max-h-40 overflow-y-auto leading-relaxed"
                                />
                                ...
                                <button
                                    ...
                                    className="p-2.5 rounded-xl bg-[#0AB600] hover:bg-[#089600] disabled:bg-zinc-300 dark:disabled:bg-zinc-800 text-white disabled:text-zinc-500 transition-all shrink-0 shadow-xs cursor-pointer disabled:cursor-not-allowed"
                                >
                                    {isLoading ? (
                            ...
                            <div className="flex items-center justify-between text-[10px] text-zinc-400 mt-2 px-1">
                                <span className="flex items-center gap-2">
                                    <span>Tekan <kbd className="font-mono bg-zinc-100 dark:bg-zinc-800 px-1 py-0.5 rounded border border-zinc-300 dark:border-zinc-700">Enter</kbd> untuk kirim, atau klik ikon mikrofon untuk bicara.</span>
                                </span>
                                <span className="hidden sm:inline">CoE STAS-RG Internal Assistant</span>
                            </div>
                        </div>
